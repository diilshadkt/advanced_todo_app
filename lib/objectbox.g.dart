...
import 'features/todo_app/data/model/todo_model.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 5983537216187316883),
      name: 'TodoModel',
      lastPropertyId: const obx_int.IdUid(3, 3747973553520871957),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5936637268555044334),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 6767248950852917879),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 5983537216187316883),
